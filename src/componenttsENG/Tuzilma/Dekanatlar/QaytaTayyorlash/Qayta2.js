...
import style from "../../../../components/Tuzilma/Dekanatlar/QaytaTayyorlash/Qayta2.module.css";
  ...
  return (
    <div className={style.main}>
      <div className={style.inMain}>
          <h2>STAFF OF THE DEANATE OF RETRAINING COURSES</h2>
          <span></span>
