...
import { fetchVacancysProducts, selectedAnyItem, ReadQuota } from '../../../actions'
                    ...
                    ? props.vacancys.map((vacancy, id) => vacancy.titleUzb.toLowerCase().includes(name.toLowerCase()) && (
                        <div key={vacancy.id} className={style.tableDetail}>
                            ...
                            <div className={style.twoButtons}>
                                ...
                                {
                                    props.admin.vacancysPermission === 'TRUE' &&
                                    <Link to='/admin/read/vacancys' onClick={() => props.ReadQuota(vacancy)}> Read</Link>
                                }
                            </div>
                        </div>
                    ))
...
export default connect(mapStateToProps, { fetchVacancysProducts, selectedAnyItem, ReadQuota })(Vacancys)
