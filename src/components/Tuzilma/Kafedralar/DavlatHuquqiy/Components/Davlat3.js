            ...
            <Zoom top cascade>
                <div className={style.grid} >
                    <div className={style.block} >
                        ...
                        <p>
                        <span>Ilmiy-metodik ishlar sohasida</span> – o‘quv jarayonining ilmiy-metodik asoslarini ishlab chiqish, o‘quv-uslubiy materiallar bilan taʼminlash, ushbu sohadagi xorijiy tajribani o‘rgangan holda professor-o‘qituvchilarning mehnat unumdorligi va taʼlim sifati hamda samaradorligini oshirishga xizmat qiladigan zamonaviy taʼlim texnologiyalarini joriy qilish; 
                        </p>
                    </div>
                    <div className={style.block} >
                        <div className={style.svg} >
                    ...
                    <div className={style.block} >
                        ...
                        <p>
                        <span>Tashkiliy-metodik ishlar sohasida</span> – taʼlim sifatini baholash, uning tahlilini olib borish, shuningdek, huquqbuzarliklar profilaktikasi va jamoat xavfsizligini taʼminlash sohasi bo‘yicha faoliyatini uslubiy va konsultativ taʼminlash hamda boshqa tashkiliy-metodik tadbirlarni samarali tashkil etish;
                        </p>
                    </div>
                    <div className={style.block} >
                        <div className={style.svg} >
