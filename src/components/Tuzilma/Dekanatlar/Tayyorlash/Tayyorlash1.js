...
import style from "./Tayyorlash1.module.css";

const Tayyorlash1 = () => {
  return (
    <div className={style.main}>
      <div className={style.inMain}>
        <h2>TAYYORLASH KURSLARI DEKANATI </h2>
        <span></span>
        <p>
          Toshkent davlat yuridik universitetining Ixtisoslashtirilgan filiali
          Tayyorlash kurslari dekanati O‘zbekiston Respublikasi Prezidentining
          2019 yil 7 fevraldagi “Xuquqbuzаrliklar profilaktikasi va jamoat
