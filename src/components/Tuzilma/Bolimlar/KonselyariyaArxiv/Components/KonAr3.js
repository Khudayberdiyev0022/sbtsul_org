      ...
      <div className={style.inMain}>
        ...
        <div className={style.grid}>
          <div className={style.block}>
            ...
            <p>
              <li>
                Kanselyariya va arxiv Filialning tarkibiy bo‘linmasi hisoblanib,
                filialda ish yuritish va elektron hujjat almashinuvini
                taʼminlash hamda filial faoliyatiga oid arxiv hujjatlarini
                tizimli hisobga olish va tegishli sharoitda saqlashni amalga
                oshiradi.
              </li>
            </p>
            <p>
              <li>
                ...
                elektron hujjat almashinuvini taʼminlash, tarkibiy bo‘linmalarda
                muxr va shtamplar hisobini yuritish, arxiv ish yurituvini
