      ...
      <div className={style.inMain}>
        ...
        <div className={style.grid}>
          <div className={style.block}>
            ...
            <p>
              Bo‘lim Filialning tarkibiy bo‘linmasi hisoblanib, harbiy xizmatga
              majburlar va chaqiriluvchilarning ro‘yxatini yuritish hamda
              xodimlarni safarbarlik vaqtida bronlashtirish ishlarini amalga
              oshiradi.
            </p>
            <p>
              Ikkinchi bo’lim harbiy xizmatga majburlar va chaqiriluvchilarning
              harbiy ro‘yxat qoidalariga rioya etishlarini ta’minlash;
            </p>
            <p>
            ...
            <p>
              harbiy xizmatga majburlar va chaqiriluvchilarni shaxsiy ro‘yxatga
              olish;
            </p>
            <p>
            ...
            <p>
              ...
              chaqirilayotganligidan xabardor etishlari hamda ularning chaqiruv
              bo‘yicha o‘z vaqtida hozir bo‘lishlarini ta’minlash;
            </p>
            <p>
              ...
              haqida mudofaa ishlari bo‘limlariga belgilangan muddatlarda xabar
              berish;
            </p>
            <p>
              fuqarolarni ishga (o‘qishga) qabul qilishda ularning harbiy hisob
              hujjatlari hisob raqamini tekshirish va ularning turar joyidan
              harbiy hisobda turishini aniqlash;
            </p>
            <p>
            ...
            <p>
              muassasalar va fuqarolar bilan bo‘lim faoliyatiga taalluqli ishlar
              bo‘yicha yozishmalarni olib borish;
            </p>
            <p>
            ...
            <p>
              ...
              yildan kam bo‘lmagan muddatda shahar va tumandagi mudofaa ishlari
              bo‘limlariga taqqoslash uchun taqdim etish;
            </p>
            <p>
