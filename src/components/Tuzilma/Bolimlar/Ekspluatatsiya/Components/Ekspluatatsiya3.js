        ...
        <div className={style.grid}>
          <div className={style.block}>
            ...
            <p>
              ...
              ashyolarini tejamli sarflanishini nazorat qilish, Filialga tashrif
              buyurgan mehmon va delegatsiyalarni qabuli bo‘yicha ishlarni
              tashkil qilish, bo‘limning ish rejalarini tuzish va ularning
              ijrosini ta’minlash.
            </p>
            <p>
              ...
              yuzasidan bo‘lim rahbariyati uchun oylik axborotlarni tayyorlash.
            </p>
            <p>
              ...
              jihoz va buyumlarni ta’mirlash ishlarini tashkil etish, bino uchun
              xizmat qiluvchi ishchi va texnik xodimlarni ish bilan ta’minlab,
              ularni boshqarish, binoning tozaligini ta’minlash, bino va undagi
              jihoz va buyumlarning saqlanishi yuzasidan tegishli muddatlarga
              hisobxonada hisob berib borish, binodagi mavjud jihozlar va
              buyumlar inventarizatsiyasini yuritish.
            </p>
          </div>
        </div>
      </div>
