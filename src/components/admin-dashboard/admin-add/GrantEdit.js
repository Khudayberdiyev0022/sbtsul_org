...
const reducer = (state, action) => {
  switch (action.type) {
    ...
    case "ALL_QUOTAS_UZB":
      return {
        ...state,
        numberOfAllQuotasUzb: action.payload,
      };
    case "ALL_QUOTAS_RUS":
      return {
        ...state,
        numberOfAllQuotasRus: action.payload,
      };
    case "ALL_QUOTAS_ENG":
      return {
        ...state,
        numberOfAllQuotasEng: action.payload,
      };
    case "DAILY_STUDENTS_UZB":
      return {
        ...state,
        numberOfStudentsDailyUzb: action.payload,
      };
    case "DAILY_STUDENTS_RUS":
      return {
        ...state,
        numberOfStudentsDailyRus: action.payload,
      };
    case "DAILY_STUDENTS_ENG":
      return {
        ...state,
        numberOfStudentsDailyEng: action.payload,
      };
    case "ALL_STUDENTS_UZB":
      return {
        ...state,
        numberOfStudentsAllUzb: action.payload,
      };
    case "ALL_STUDENTS_RUS":
      return {
        ...state,
        numberOfStudentsAllRus: action.payload,
      };
    case "ALL_STUDENTS_ENG":
      return {
        ...state,
        numberOfStudentsAllEng: action.payload,
      };
    case "CLEAR":
      return initialState;
    case "CLICKED":
...
function GrantEdit(props) {
  ...
  useEffect(() => {
    ...
    dispatch({
      type: "ALL_QUOTAS_UZB",
      payload: props.item?.numberOfAllQuotasUzb,
    });
    dispatch({
      type: "ALL_QUOTAS_RUS",
      payload: props.item?.numberOfAllQuotasRus,
    });
    dispatch({
      type: "ALL_QUOTAS_ENG",
      payload: props.item?.numberOfAllQuotasEng,
    });
    dispatch({
      type: "DAILY_STUDENTS_UZB",
      payload: props.item?.numberOfStudentsDailyUzb,
    });
    dispatch({
      type: "DAILY_STUDENTS_RUS",
      payload: props.item?.numberOfStudentsDailyRus,
    });
    dispatch({
      type: "DAILY_STUDENTS_ENG",
      payload: props.item?.numberOfStudentsDailyEng,
    });
    dispatch({
      type: "ALL_STUDENTS_UZB",
      payload: props.item?.numberOfStudentsAllUzb,
    });
    dispatch({
      type: "ALL_STUDENTS_RUS",
      payload: props.item?.numberOfStudentsAllRus,
    });
    dispatch({
      type: "ALL_STUDENTS_ENG",
      payload: props.item?.numberOfStudentsAllEng,
    });
          ...
          <div className={style.forms}>
            <div className={style.block}>
              ...
              <textarea
                ...
                type="text"
                onChange={(e) =>
                  dispatch({ type: "ALL_QUOTAS_UZB", payload: e.target.value })
                }
              />
            ...
            <div className={style.block}>
              ...
              <textarea
                ...
                type="text"
                onChange={(e) =>
                  dispatch({ type: "ALL_QUOTAS_ENG", payload: e.target.value })
                }
              />
            ...
            <div className={style.block}>
              ...
              <textarea
                ...
                type="text"
                onChange={(e) =>
                  dispatch({ type: "ALL_QUOTAS_RUS", payload: e.target.value })
                }
              />
