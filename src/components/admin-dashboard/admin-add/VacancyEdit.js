...
const reducer = (state, action) => {
  switch (action.type) {
    ...
    case "COST_UZB":
      return {
        ...state,
        costUzb: action.payload,
      };
    case "COST_RUS":
      return {
        ...state,
        costRus: action.payload,
      };
    case "COST_ENG":
      return {
        ...state,
        costEng: action.payload,
      };
    case "SUBTITLE_UZB":
      return {
        ...state,
        subTitleUzb: action.payload,
      };
    case "SUBTITLE_RUS":
      return {
        ...state,
        subTitleRus: action.payload,
      };
    case "SUBTITLE_ENG":
      return {
        ...state,
        subTitleEng: action.payload,
      };
    case "CLEAR":
      return initialState;
    case "CLICKED":
          ...
          <div className={style.forms}>
            <div className={style.block}>
              ...
              <input
                ...
                type="text"
                onChange={(e) =>
                  dispatch({ type: "SUBTITLE_UZB", payload: e.target.value })
                }
              />
              <h2>Matn</h2>
              <textarea
              ...
              <textarea
                ...
                type="text"
                onChange={(e) =>
                  dispatch({ type: "COST_UZB", payload: e.target.value })
                }
              />
            </div>
            <div className={style.block}>
              ...
              <input
                ...
                type="text"
                onChange={(e) =>
                  dispatch({ type: "SUBTITLE_ENG", payload: e.target.value })
                }
              />
              <h2>Paragraph</h2>
              <textarea
              ...
              <textarea
                ...
                type="text"
                onChange={(e) =>
                  dispatch({ type: "COST_ENG", payload: e.target.value })
                }
              />
            </div>
            <div className={style.block}>
              ...
              <input
                ...
                type="text"
                onChange={(e) =>
                  dispatch({ type: "SUBTITLE_RUS", payload: e.target.value })
                }
              />
              <h2>текст</h2>
              <textarea
              ...
              <textarea
                ...
                type="text"
                onChange={(e) =>
                  dispatch({ type: "COST_RUS", payload: e.target.value })
                }
              />
            </div>
          </div>
