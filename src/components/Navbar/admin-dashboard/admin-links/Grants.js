...
import { fetchQuotasProducts, selectedAnyItem, ReadQuota } from '../../../actions'
                    ...
                    ? props.quotas.map((quota, id) => quota.titleUzb.toLowerCase().includes(name.toLowerCase()) && (
                        <div key={quota.id} className={style.tableDetail}>
                            ...
                            <div className={style.twoButtons}>
                                {props.admin.quotasPermission === 'TRUE' && <Link to='/admin/delete/quotas' onClick={() => props.selectedAnyItem(quota)}>Delete</Link>}
                                {props.admin.quotasPermission === 'TRUE' && <Link to='/admin/edit/quotas' onClick={() => props.selectedAnyItem(quota)}> Edit</Link>}
                                {props.admin.quotasPermission === 'TRUE' && <Link to='/admin/read/quotas' onClick={() => props.ReadQuota(quota)}> Read</Link>}
                            </div>
                        </div>
                    ))
                    : <LoaderComponent />
                ...
                <Fragment>
                    ...
                    <div className={style.searcher}>
                        ...
                        <div className={style.buttons}>
                            ...
                            />
                            {props.admin.quotasPermission === 'TRUE' && <button
                                type="button"
                            >
...
export default connect(mapStateToProps, { fetchQuotasProducts, selectedAnyItem, ReadQuota })(Grants)
