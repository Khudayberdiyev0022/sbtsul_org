...
export default connect(mapStateToProps, { fetchMessagesProducts, fetchVacancysProducts, fetchImagesProducts, fetchNewsProducts, fetchStudentProducts, fetchQuotasProducts })(BarChart);